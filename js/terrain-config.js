...
// ── Mountain Profiles ──
export const RIDGE_STRENGTH = 0.12;
...
// ── Fold Ridges ──
export const FOLD_FREQ_PRIMARY = 120;
export const FOLD_FREQ_SECONDARY = 300;
...
// ── Dissection & Summits ──
export const DISSECT_THRESHOLD = 0.12;
export const DISSECT_AMP = 0.4;
